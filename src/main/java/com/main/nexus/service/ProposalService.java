...
public class ProposalService {
    ...
    public Proposal submitProposal(ProposalRequestDTO request, Long professionalId) {
        ...
        boolean alreadyPending = proposalRepository
                .findByProjectIdAndProfessionalIdAndStatus(
                        project.getId(), professionalId, ProposalStatus.PENDING)
                .isPresent();
        if (alreadyPending) {
    ...
    // MatchService.companyShowsInterestByProject), sem exigir que o fluxo de interesse
